const NodeSOAPWrapper = require('node-soap-wrapper').NodeSOAPWrapper;
...
DHLNodeAPI.prototype.setAuthData = function setAuthData(username, password) {
  this.authData = new Structures.AuthData(username, password);
};
...
DHLNodeAPI.prototype.createShipments = function createShipments(shipments) {
  return this.client.createShipments({
...
DHLNodeAPI.prototype.deleteShipments = function deleteShipments(shipments) {
  return this.client.deleteShipments({
    authData: this.authData,
    shipments: shipments,
  });
};
 ...
 */
DHLNodeAPI.prototype.getMyShipments = function getMyShipments(
  createdFrom,
  createdTo,
  offset
) {
  return this.client.getMyShipments({
    authData: this.authData,
 ...
 * @param {string} createdTo Koniec zakresu czasowego, data w formacie RRRR-MM-DD.
 */
DHLNodeAPI.prototype.getMyShipmentsCount = function getMyShipmentsCount(
  createdFrom,
  createdTo
) {
  return this.client.getMyShipmentsCount({
    authData: this.authData,
    createdFrom: createdFrom,
    createdTo: createdTo,
  });
 ...
 */
DHLNodeAPI.prototype.getPostalCodeServices = function getPostalCodeServices(
  postCode,
  pickupDate
) {
  return this.client.getPostalCodeServices({
    authData: this.authData,
    postCode: postCode,
 ...
 */
DHLNodeAPI.prototype.getTrackAndTraceInfo = function getTrackAndTraceInfo(
  shipmentId
) {
  return this.client.getTrackAndTraceInfo({
    authData: this.authData,
 ...
 */
DHLNodeAPI.prototype.bookCourier = function bookCourier(
  pickupDate,
  pickupTimeFrom,
  pickupTimeTo,
  additionalInfo,
  ...
  return this.client.bookCourier({
    authData: this.authData,
    pickupDate: pickupDate,
 ...
 */
DHLNodeAPI.prototype.cancelCourierBooking = function cancelCourierBooking(
  orders
) {
  return this.client.cancelCourierBooking({
    authData: this.authData,
    orders: orders,
  });
};
...
DHLNodeAPI.prototype.getPnp = function getPnp(pnpRequest) {
  pnpRequest.authData = this.authData;

  return this.client.getPnp({
...
DHLNodeAPI.prototype.getShipmentScan = function getShipmentScan(shipmentId) {
  return this.client.getShipmentScan({
    authData: this.authData,
    shipmentId: shipmentId,
  });
};
...
DHLNodeAPI.prototype.deleteShipment = function deleteShipment(shipment) {
  return this.client.deleteShipment({
    authData: this.authData,
    shipment: shipment,
  });
};
...
/**
 * Przy pomocy tej metody możliwe jest - w jednym żądaniu - pobranie wszystkich informacji dotyczącej przesyłki.
 * @param {ArrayOfString} itemsToLabelData
 */
DHLNodeAPI.prototype.getLabelsData = function getLabelsData(itemsToLabelData) {
  return this.client.getLabelsData({
    authData: this.authData,
    itemsToLabelData: itemsToLabelData,
  });
};
